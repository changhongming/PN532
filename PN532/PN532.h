...
public:
    ...
    */
    ...
    uint8_t mifareclassic_IncrementValueBlock (uint8_t blockNumber, uint32_t value);
    uint8_t mifareclassic_DecrementValueBlock (uint8_t blockNumber, uint32_t value);
    uint8_t mifareclassic_TransferValueBlock (uint8_t blockNumber);
    uint8_t mifareclassic_ReadValueBlock (uint8_t blockNumber, uint32_t &value);
    uint8_t mifareclassic_FormatValue (uint8_t blockNumber, uint32_t value);
